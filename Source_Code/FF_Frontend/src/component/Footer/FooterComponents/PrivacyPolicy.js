...
export default function PrivacyPolicy() {
  return (
    <div className="privacy-policy">
      ...
      <p>
        Welcome to RecipeShare! This Privacy Policy describes how we collect,
        use, and disclose information when you use our platform.
      </p>
      ...
      <ul>
        ...
        <li>
          Content: such as recipes, comments, and other user-generated content.
        </li>
      </ul>
